...
$"??_C@_08OEPEJJJA@Hello?5C?6?$AA@" = comdat any

@"??_C@_08OEPEJJJA@Hello?5C?6?$AA@" = linkonce_odr dso_local unnamed_addr constant [9 x i8] c"Hello C\0A\00", comdat, align 1
...
define dso_local i32 @main() #0 {
  ...
  %2 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_08OEPEJJJA@Hello?5C?6?$AA@")
  ret i32 0
}
